...
const { 
  getUsers, deleteUser, getStats, getOrders, updateOrderStatus } = require("../controllers/adminController");

router.get("/users", protect, adminOnly, getUsers);
router.delete("/users/:id", protect, adminOnly, deleteUser); // Implement deleteUser in adminController.js

router.get("/stats", protect, adminOnly, getStats); // Implement getStats in adminController.js
