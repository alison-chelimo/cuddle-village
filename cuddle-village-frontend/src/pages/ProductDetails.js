...
export default function Products() {
  ...
  useEffect(() => {
    API.get("/products")
      .then(res => { setApiProducts(res.data.map(enrichProduct)); setLoadedFromApi(true); })
      .catch(() => setLoadedFromApi(false));
  }, []);

  const allProducts = loadedFromApi ? apiProducts : FLAT_PRODUCTS;
    ...
    <>
      <style>{`
        ...
        .products-hero-overlay {
          ...
          background: linear-gradient(to top, rgba(45,38,64,0.80) 0%, rgba(45,38,64,0.25) 55%, transparent 100%);
          display: flex;
        ...
        .products-hero h1 { font-size:36px; font-weight:900; margin:0 0 8px; color:#fff; }
        .products-hero p  { font-size:15px; color:#ccc; margin:0; font-weight:600; }
        ...
        @media (max-width:900px) {
          ...
          .products-hero-overlay { padding:24px; }
      ...
      <div className="products-page">
        ...
        <div className="products-hero">
          <img src={storeImg} alt="The Cuddle Village store" className="products-hero-img" />
