    ...
    <>
      <style>{`
        ...
        .add-product-btn {
          ...
          font-family: 'Nunito', sans-serif;
          transition: all 0.2s;
          box-shadow: 0 6px 20px rgba(175,167,231,0.4);
        }
        .add-product-btn:hover {
          transform: translateY(-2px);
          box-shadow: 0 10px 26px rgba(175,167,231,0.5);
        }
        ...
        .stat-mini {
          ...
          box-shadow: 0 4px 16px rgba(175,167,231,0.1);
          display: flex;
          align-items: center;
          gap: 14px;
        }
        ...
        @media (max-width: 768px) {
          ...
          .products-toolbar { flex-direction: column !important; align-items: flex-start !important; gap: 12px !important; }
